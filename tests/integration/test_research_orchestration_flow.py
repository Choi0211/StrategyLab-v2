...
class ResearchOrchestrationFlowTest(unittest.TestCase):
    def test_telegram_style_approval_flow(self) -> None:
        ...
        proposal, approval, awaiting = orchestrator.propose(request, chat_id="100", approval_token="token-tg", expires_at="2026-07-18T00:00:00Z")
        ...
        running = orchestrator.start(proposal.proposal_id, approval_token="token-tg")
